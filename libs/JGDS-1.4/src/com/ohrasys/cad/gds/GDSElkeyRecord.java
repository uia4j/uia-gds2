...
extends GDSRecord {
   ...
   */
  public GDSElkeyRecord()
    throws GDSRecordException {
    throw new GDSRecordException(i18n.getString(i18n.i18n_ELKEY_CTOR));
  }
   ...
   */
  public GDSElkeyRecord(GDSRecord rec)
    throws GDSRecordException {
   ...
   * @throws  GDSRecordException  If the record is malformed.
   */
  public GDSElkeyRecord(short length, byte rectype, byte dattype,
      byte data[])
    throws GDSRecordException {
   ...
   */
  public String toString(){return i18n.getString(i18n.i18n_ELKEY_TOSTRING);}
