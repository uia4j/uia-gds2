...
extends InputStreamReader {
   ...
   *                                 readable.
   */
  public GDSReader(File file)
    throws FileNotFoundException{this(file, false);}
   ...
   *                                 readable.
   */
  public GDSReader(FileDescriptor fd)
    throws FileNotFoundException{this(fd, false);}
  ...
  public GDSReader(String fileName)
    throws FileNotFoundException{this(fileName, false);}
   ...
   *                                 readable.
   */
  public GDSReader(GDSInputStream in, boolean validating)
   ...
   *                                 readable.
   */
  public GDSReader(FileDescriptor fd, boolean validating)
    throws FileNotFoundException{this(new GDSInputStream(fd), validating);}
   ...
   *                                 readable.
   */
  public GDSReader(String fileName, boolean validating)
    throws FileNotFoundException {
   ...
   *                                 readable.
   */
  public GDSReader(File file, boolean validating)
    throws FileNotFoundException{this(new GDSInputStream(file), validating);}
  ...
  public int getRead()
    ...
    if(in == null) {
      throw new GDSReaderException(i18n.getString(
          i18n.i18n_GDSREADER_THROW1));
    }
  ...
  public void mark(int readAheadLimit)
    throws IOException {
    throw new IOException(i18n.getString(i18n.i18n_GDSREADER_THROW2));
  }
  ...
  public Object readRecord()
    ...
    bytesRead += result.getLength();
    if(validating) {
      isValid.test(new BNFTestableObject(result) {
  ...
  public void reset()
    throws IOException {
    throw new IOException(i18n.getString(i18n.i18n_GDSREADER_THROW3));
  }
