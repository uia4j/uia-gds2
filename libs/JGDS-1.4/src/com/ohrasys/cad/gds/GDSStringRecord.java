...
extends GDSRecord {
   ...
   */
  public GDSStringRecord(GDSRecord rec)
   ...
   */
  public GDSStringRecord(String string)
    throws GDSRecordException {
    setString(string);
    this.rectype = STRING;
   ...
   */
  public GDSStringRecord(short length, byte rectype, byte dattype,
      byte data[])
    throws GDSRecordException {
   ...
   * @return  The string.
   */
  public String getString(){return new String(string);}
  ...
  public String toString() {
    return GDSStringUtil.sprintf(i18n.getString(i18n.i18n_STRING_TOSTRING),
        string);
  }
  ...
  private String validate(String string)
    ...
    if((string != null) && (string.length() >= 1) &&
        (string.length() <= 512)){return string;}

    throw new GDSRecordException(i18n.getString(i18n.i18n_STRING_THROW));
  }
