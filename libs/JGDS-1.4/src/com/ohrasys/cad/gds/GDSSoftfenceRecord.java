 ...
 * @since    1.5
 */
public class GDSSoftfenceRecord
extends GDSRecord {
  /**
   ...
   */
  public GDSSoftfenceRecord(GDSRecord rec)
    throws GDSRecordException {
   ...
   * @throws  GDSRecordException  If the record is malformed.
   */
  public GDSSoftfenceRecord(short length, byte rectype, byte dattype,
      byte data[])
    throws GDSRecordException {
  ...
  public String toString() {
    return i18n.getString(i18n.i18n_SOFTFENCE_TOSTRING);
  }
