...
extends GDSRecord {
   ...
   */
  public GDSStrtypeRecord()
    throws GDSRecordException {
    throw new GDSRecordException(i18n.getString(i18n.i18n_STRTYPE_THROW));
  }
   ...
   */
  public GDSStrtypeRecord(GDSRecord rec)
    throws GDSRecordException {
   ...
   * @throws  GDSRecordException  If the record is malformed.
   */
  public GDSStrtypeRecord(short length, byte rectype, byte dattype,
      byte data[])
    throws GDSRecordException {
   ...
   */
  public String toString(){return i18n.getString(i18n.i18n_STRTYPE_TOSTRING);}
