 ...
 * @since    1.5
 */
public class GDSLibdirsizeRecord
extends GDSRecord {
   ...
   */
  public GDSLibdirsizeRecord(short libdirsize)
   ...
   *                              record.
   */
  public GDSLibdirsizeRecord(GDSRecord rec)
    throws GDSRecordException {
   ...
   */
  public GDSLibdirsizeRecord(short length, byte rectype, byte dattype,
      byte data[])
    throws GDSRecordException {
   ...
   */
  public short getLibdirsize(){return this.libdirsize;}
   ...
   * @throws  GDSRecordException  If the number of pages is 0.
   */
  public void setLibdirsize(short libdirsize)
    throws GDSRecordException {
  ...
  public String toString() {
    return GDSStringUtil.sprintf(i18n.getString(
          i18n.i18n_LIBDIRSIZE_TOSTRING), libdirsize);
  }
   ...
   *                              equal to zero
   */
  private short validate(short libdirsize)
    throws GDSRecordException {
    if(libdirsize >= 1){return libdirsize;}

    throw new GDSRecordException(i18n.getString(
        i18n.i18n_LIBDIRSIZE_THROW));
  }
