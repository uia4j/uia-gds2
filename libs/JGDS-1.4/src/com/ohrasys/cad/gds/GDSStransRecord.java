...
extends GDSRecord {
   ...
   */
  public GDSStransRecord(boolean isMirroredX, boolean isAbsMag,
      boolean isAbsAngle)
    throws GDSRecordException {
   ...
   * @throws  GDSRecordException  If the record is malformed.
   */
  public GDSStransRecord(short length, byte rectype, byte dattype,
      byte data[])
    throws GDSRecordException {
   ...
   */
  public boolean isAbsAngle(){return absAngle;}
   ...
   */
  public boolean isAbsMag(){return this.absMag;}
   ...
   */
  public boolean isMirroredX(){return this.mirroredX;}
  ...
  public String toString() {
    String result = i18n.getString(i18n.i18n_STRANS_TOSTRING);
    result += (mirroredX ? " MirroredX:" /*NOI18N*/
                         : " UnmirroredX:" /*NOI18N*/);
    result += (absMag ? "AbsMagnification:" /*NOI18N*/
                      : "RelMagnification:" /*NOI18N*/);
    result += (absAngle ? "AbsAngle" /*NOI18N*/ : "RelAngle" /*NOI18N*/);
  ...
  private byte[] updateData() {
    ...
    if(mirroredX){result = (short)(result | 0x8000);}

    if(absMag){result = (short)(result | 0x0004);}

    if(absAngle){result = (short)(result | 0x0002);}
