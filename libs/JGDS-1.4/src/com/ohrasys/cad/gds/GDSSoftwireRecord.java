 ...
 * @since    1.5
 */
public class GDSSoftwireRecord
extends GDSRecord {
  /**
   ...
   */
  public GDSSoftwireRecord(GDSRecord rec)
    throws GDSRecordException {
   ...
   * @throws  GDSRecordException  If the record is malformed.
   */
  public GDSSoftwireRecord(short length, byte rectype, byte dattype,
      byte data[])
    throws GDSRecordException {
   ...
   */
  public String toString(){return i18n.getString(i18n.i18n_SOFTWIRE_TOSTRING);}
