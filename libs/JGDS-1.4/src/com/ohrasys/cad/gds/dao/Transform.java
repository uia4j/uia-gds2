...
implements InfoProvider {
   ...
   */
  public Transform(){this(0.0, 1.0, false, false, false);}
   ...
   */
  public Transform(double angle, double magnification, boolean isMirrored,
      boolean isRelativeAngle, boolean isRelativeMagnification) {
  ...
  public String getInfo() {
    ...
    result += (i18n.getString("I18N_XFRM_MIRD" /*NOI18N*/) +
        (mirrored ? i18n.getString("I18N_XFRM_YES" /*NOI18N*/)
                  : i18n.getString("I18N_XFRM_NO" /*NOI18N*/)) +
        "\n" /*NOI18N*/);
    result += (i18n.getString("I18N_XFRM_RANG" /*NOI18N*/) +
        (relativeAngle ? i18n.getString("I18N_XFRM_YES" /*NOI18N*/)
                       : i18n.getString("I18N_XFRM_NO" /*NOI18N*/)) +
        "\n" /*NOI18N*/);
    result += (i18n.getString("I18N_XFRM_RMAG" /*NOI18N*/) +
        (relativeMagnification ? i18n.getString("I18N_XFRM_YES" /*NOI18N*/)
                               : i18n.getString("I18N_XFRM_YES" /*NOI18N*/)) +
        "\n" /*NOI18N*/);
    result += (i18n.getString("I18N_XFRM_ANG" /*NOI18N*/) +
        String.format("%.4f" /*NOI18N*/, angle) +
        "\n" /*NOI18N*/);
    result += (i18n.getString("I18N_XFRM_MAG" /*NOI18N*/) +
        String.format("%.4f" /*NOI18N*/, magnification) +
        "\n" /*NOI18N*/);
   ...
   */
  public double getMagnification(){return this.magnification;}
   ...
   */
  public boolean isRelativeAngle(){return this.relativeAngle;}
   ...
   */
  public boolean isRelativeMagnification(){return this.relativeMagnification;}
   ...
   */
  public String toString(){return i18n.getString("I18N_XFRM_XFRM" /*NOI18N*/);}
} // end class Transform
