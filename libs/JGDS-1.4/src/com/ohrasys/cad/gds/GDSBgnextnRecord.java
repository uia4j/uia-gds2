...
extends GDSRecord {
   ...
   */
  public GDSBgnextnRecord(int bgnextn)
   ...
   * @throws  GDSRecordException  If the record is malformed.
   */
  public GDSBgnextnRecord(GDSRecord rec)
    throws GDSRecordException {
   ...
   * @throws  GDSRecordException  If the record is malformed.
   */
  public GDSBgnextnRecord(short length, byte rectype, byte dattype,
      byte data[])
    throws GDSRecordException {
   ...
   */
  public int getBgnextn(){return this.bgnextn;}
  ...
  public String toString() {
    return GDSStringUtil.sprintf(i18n.getString(
          i18n.i18n_BGNEXTN_TOSTRING), bgnextn);
  }
