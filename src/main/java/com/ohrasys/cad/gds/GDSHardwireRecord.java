 ...
 * @since    1.5
 */
public class GDSHardwireRecord
extends GDSRecord {
  /**
   ...
   */
  public GDSHardwireRecord(GDSRecord rec)
    throws GDSRecordException {
   ...
   * @throws  GDSRecordException  If the record is malformed.
   */
  public GDSHardwireRecord(short length, byte rectype, byte dattype,
      byte data[])
    throws GDSRecordException {
   ...
   */
  public String toString(){return i18n.getString(i18n.i18n_HARDWIRE_TOSTRING);}
