 ...
 * @since    1.5
 */
public class GDSAttrtableRecord extends GDSRecord {
     ...
     */
    public GDSAttrtableRecord(GDSRecord rec) throws GDSRecordException {
     ...
     *                              requirements.
     */
    public GDSAttrtableRecord(String attrtable) throws GDSRecordException {
     ...
     */
    public GDSAttrtableRecord(int length, byte rectype, byte dattype, byte data[]) throws GDSRecordException {
    ...
    public String getAttrtable() {
        return new String(this.attrtable);
    }
     ...
     *                              requirements.
     */
    public void setAttrtable(String attrtable) throws GDSRecordException {
        if ((attrtable == null) || (attrtable.length() < 1) ||
                (attrtable.length() > 44)) {
            throw new GDSRecordException(GDSI18NFactory.getString(
                    GDSI18NFactory.i18n_ATTRTBL_THROW));
        }
    ...
    public String toString() {
        return GDSStringUtil.sprintf(GDSI18NFactory.getString(
                GDSI18NFactory.i18n_ATTRTBL_TOSTRING), this.attrtable);
    }
