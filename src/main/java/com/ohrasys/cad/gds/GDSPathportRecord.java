 ...
 * @since    1.5
 */
public class GDSPathportRecord
extends GDSRecord {
  /**
   ...
   */
  public GDSPathportRecord(GDSRecord rec)
    throws GDSRecordException {
   ...
   * @throws  GDSRecordException  If the record is malformed.
   */
  public GDSPathportRecord(short length, byte rectype, byte dattype,
      byte data[])
    throws GDSRecordException {
   ...
   */
  public String toString(){return i18n.getString(i18n.i18n_PATHPORT_TOSTRING);}
