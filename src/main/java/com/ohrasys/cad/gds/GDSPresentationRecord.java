 ...
 * @since    1.5
 */
public class GDSPresentationRecord extends GDSRecord {
     ...
     *                              record.
     */
    public GDSPresentationRecord(GDSRecord rec) throws GDSRecordException {
     ...
     */
    public GDSPresentationRecord(int font, int vjust, int hjust) throws GDSRecordException {
     ...
     * @throws  GDSRecordException  If the record is malformed.
     */
    public GDSPresentationRecord(int length, byte rectype, byte dattype, byte data[]) throws GDSRecordException {
     ...
     *                              or FONT3.
     */
    public void setFont(int font) throws GDSRecordException {
        this.font = validateFont(font);
        this.data = updateData();
    }
     ...
     *                              CENTER or RIGHT.
     */
    public void setHJustification(int hJustification) throws GDSRecordException {
     ...
     *                              or BOTTOM.
     */
    public void setVJustification(int vJustification) throws GDSRecordException {
        ...
        switch (this.vJustification) {
            case 0:
                result = GDSStringUtil.sprintf(GDSI18NFactory.getString(
                        GDSI18NFactory.i18n_PRESENTATION_TOSTRING1), this.font);

                break;

            case 1:
                result = GDSStringUtil.sprintf(GDSI18NFactory.getString(
                        GDSI18NFactory.i18n_PRESENTATION_TOSTRING2), this.font);

                break;

            case 2:
                result = GDSStringUtil.sprintf(GDSI18NFactory.getString(
                        GDSI18NFactory.i18n_PRESENTATION_TOSTRING3), this.font);

                break;

            default:
                result = GDSStringUtil.sprintf(GDSI18NFactory.getString(
                        GDSI18NFactory.i18n_PRESENTATION_TOSTRING4), this.font);
        }

        switch (this.hJustification) {
            case 0:
                result += GDSI18NFactory.getString(GDSI18NFactory.i18n_PRESENTATION_TOSTRING5);

                break;

            case 1:
                result += GDSI18NFactory.getString(GDSI18NFactory.i18n_PRESENTATION_TOSTRING6);

                break;

            case 2:
                result += GDSI18NFactory.getString(GDSI18NFactory.i18n_PRESENTATION_TOSTRING7);

                break;

            default:
                result += GDSI18NFactory.getString(GDSI18NFactory.i18n_PRESENTATION_TOSTRING8);
        }
    ...
    private byte[] updateData() {
        ...
        result = (short) (result | this.hJustification);
        result = (short) (result | (this.vJustification << 2));
        result = (short) (result | (this.font << 4));
     ...
     */
    private int validateFont(int font) throws GDSRecordException {
        if ((font >= FONT0) && (font <= FONT3)) {
            return font;
        }

        throw new GDSRecordException(GDSI18NFactory.getString(
                GDSI18NFactory.i18n_PRESENTATION_THROW1));
    }
     ...
     */
    private int validateJustification(int just) throws GDSRecordException {
        if ((just >= LEFT) && (just <= RIGHT)) {
            return just;
        }

        throw new GDSRecordException(GDSI18NFactory.getString(
                GDSI18NFactory.i18n_PRESENTATION_THROW2));
    }
