 ...
 * @since    1.5
 */
public class GDSPropvalueRecord
extends GDSRecord {
  /** The property value */
   ...
   */
  public GDSPropvalueRecord(GDSRecord rec)
   ...
   */
  public GDSPropvalueRecord(String propvalue)
    throws GDSRecordException {
   ...
   */
  public GDSPropvalueRecord(short length, byte rectype, byte dattype,
      byte data[])
    throws GDSRecordException {
   ...
   */
  public String getPropvalue(){return new String(propvalue);}
  ...
  public String toString() {
    return GDSStringUtil.sprintf(i18n.getString(
          i18n.i18n_PROPVALUE_TOSTRING), propvalue);
  }
   ...
   */
  private String validate(String propvalue)
    throws GDSRecordException {
    if((propvalue != null) &&
