...
extends GDSRecord {
   ...
   */
  public GDSPlexRecord(GDSRecord rec)
   ...
   */
  public GDSPlexRecord(short length, byte rectype, byte dattype,
      byte data[])
    throws GDSRecordException {
   ...
   * @return  The plex.
   */
  public int getPlex(){return this.plex;}
  ...
  public String toString() {
    return GDSStringUtil.sprintf(i18n.getString(i18n.i18n_PLEX_TOSTRING),
        plex);
  }
   ...
   */
  private int validate(int plex)
    throws GDSRecordException {
    if(plex >= 0){return plex;}

    throw new GDSRecordException(i18n.getString(i18n.i18n_PLEX_THROW));
  }
