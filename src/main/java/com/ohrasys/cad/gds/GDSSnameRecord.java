 ...
 * @since    1.5
 */
public class GDSSnameRecord extends GDSRecord {
     ...
     */
    public GDSSnameRecord(GDSRecord rec) throws GDSRecordException {
     ...
     *                              [A-Z,a-z,0-9,?,_,$].
     */
    public GDSSnameRecord(String sname) throws GDSRecordException {
        setSname(sname);
        this.rectype = SNAME;
     ...
     */
    public GDSSnameRecord(int length, byte rectype, byte dattype, byte data[]) throws GDSRecordException {
     ...
     *                              [A-Z,a-z,0-9,?,_,$].
     */
    public void setSname(String sname) throws GDSRecordException {
    ...
    public String toString() {
        return (GDSStringUtil.sprintf(GDSI18NFactory.getString(GDSI18NFactory.i18n_SNAME_TOSTRING),
                this.sname));
    }
     ...
     */
    private String validate(String sname) throws GDSRecordException {
        if ((sname == null) || (sname.length() < 1) ||
                (sname.length() > MAX_REC_LEN)) {
            throw new GDSRecordException(GDSI18NFactory.getString(
                    GDSI18NFactory.i18n_SNAME_THROW1));
        }
        ...
        if (!GDSStringUtil.consistsOf(sname.toLowerCase(), validChars)) {
            throw new GDSRecordException(GDSI18NFactory.getString(
                    GDSI18NFactory.i18n_SNAME_THROW2));
        }
