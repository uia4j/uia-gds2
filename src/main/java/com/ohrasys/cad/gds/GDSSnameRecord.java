...
public class GDSSnameRecord extends GDSRecord {
     ...
     */
    public GDSSnameRecord(short length, byte rectype, byte dattype, byte data[]) throws GDSRecordException {
    ...
    public String toString() {
        return (GDSStringUtil.sprintf(this.i18n.getString(this.i18n.i18n_SNAME_TOSTRING),
                this.sname));
    }
