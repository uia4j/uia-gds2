...
extends GDSRecord {
   ...
   */
  public GDSColrowRecord(GDSRecord rec)
   ...
   */
  public GDSColrowRecord(short col, short row)
    throws GDSRecordException {
   ...
   * @throws  GDSRecordException  If the record is malformed.
   */
  public GDSColrowRecord(short length, byte rectype, byte dattype,
      byte data[])
    throws GDSRecordException {
   ...
   */
  public short getNumcol(){return this.numcol;}
   ...
   */
  public short getNumrow(){return this.numrow;}
   ...
   *                              0:32767.
   */
  public void setNumcol(short ncol)
    throws GDSRecordException {
   ...
   *                              0:32767.
   */
  public void setNumrow(short nrow)
    throws GDSRecordException {
  ...
  public String toString() {
    return GDSStringUtil.sprintf(i18n.getString(i18n.i18n_COLROW_TOSTRING),
        numrow, numcol);
  }
  ...
  private byte[] updateData() {
    ...
    baos = GDSByteConverter.fromShort(numcol, baos);
    baos = GDSByteConverter.fromShort(numrow, baos);
   ...
   */
  private short validate(short num)
    throws GDSRecordException {
    if((num >= 0) && (num <= 32767)){return num;}

    throw new GDSRecordException(i18n.getString(i18n.i18n_COLROW_THROW));
  }
