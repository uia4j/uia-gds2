 ...
 * @since    1.5
 */
public class GDSBoxRecord extends GDSRecord {
     ...
     */
    public GDSBoxRecord() throws GDSRecordException {
        this.rectype = BOX;
     ...
     */
    public GDSBoxRecord(GDSRecord rec) throws GDSRecordException {
     ...
     * @throws  GDSRecordException  If the record is malformed.
     */
    public GDSBoxRecord(int length, byte rectype, byte dattype, byte data[]) throws GDSRecordException {
    ...
    public String toString() {
        return GDSI18NFactory.getString(GDSI18NFactory.i18n_BOX_TOSTRING);
    }
