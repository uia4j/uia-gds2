 ...
 * @since    1.5
 */
public class GDSGenerationsRecord
extends GDSRecord {
   ...
   *                              record.
   */
  public GDSGenerationsRecord(GDSRecord rec)
   ...
   *                              range of 2:99
   */
  public GDSGenerationsRecord(short generations)
    throws GDSRecordException {
   ...
   */
  public GDSGenerationsRecord(short length, byte rectype, byte dattype,
      byte data[])
    throws GDSRecordException {
   ...
   *          retain.
   */
  public short getGenerations(){return this.generations;}
  ...
  public String toString() {
    return GDSStringUtil.sprintf(i18n.getString(
          i18n.i18n_GENERATIONS_TOSTRING), generations);
  }
   ...
   */
  private short validate(short generations)
    throws GDSRecordException {
    if((generations >= 2) && (generations <= 99)){return generations;}

    throw new GDSRecordException(i18n.getString(
        i18n.i18n_GENERATIONS_THROW));
  }
