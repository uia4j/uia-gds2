 ...
 * @since    1.5
 */
public class GDSPathtypeRecord
extends GDSRecord {
   ...
   */
  public GDSPathtypeRecord(GDSRecord rec)
   ...
   *                              SQUARE, VARIABLE.
   */
  public GDSPathtypeRecord(short pathtype)
    throws GDSRecordException {
   ...
   */
  public GDSPathtypeRecord(short length, byte rectype, byte dattype,
      byte data[])
    throws GDSRecordException {
   ...
   */
  public short getPathtype(){return this.pathtype;}
  ...
  public String toString() {
    ...
    switch(pathtype) {
      case 0:
        result = i18n.getString(i18n.i18n_PATHTYPE_TOSTRING1);

        break;

      case 1:
        result = i18n.getString(i18n.i18n_PATHTYPE_TOSTRING2);

        break;

      case 2:
        result = i18n.getString(i18n.i18n_PATHTYPE_TOSTRING3);

        break;

      case 4:
        result = i18n.getString(i18n.i18n_PATHTYPE_TOSTRING4);

        break;

      default:
        result = i18n.getString(i18n.i18n_PATHTYPE_TOSTRING5);
    }
   ...
   */
  private short validate(short pathtype)
    throws GDSRecordException {
    if((pathtype == FLUSH) || (pathtype == ROUND) ||
        (pathtype == SQUARE) || (pathtype == VARIABLE)){return pathtype;}

    throw new GDSRecordException(i18n.getString(i18n.i18n_PATHTYPE_THROW));
  }
