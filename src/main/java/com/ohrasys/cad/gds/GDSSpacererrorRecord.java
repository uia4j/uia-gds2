 ...
 * @since    1.5
 */
public class GDSSpacererrorRecord extends GDSRecord {
     ...
     */
    public GDSSpacererrorRecord() throws GDSRecordException {
     ...
     *                              record.
     */
    public GDSSpacererrorRecord(GDSRecord rec) throws GDSRecordException {
     ...
     * @throws  GDSRecordException  If the record is malformed.
     */
    public GDSSpacererrorRecord(int length, byte rectype, byte dattype, byte data[]) throws GDSRecordException {
    ...
    public String toString() {
        return GDSI18NFactory.getString(GDSI18NFactory.i18n_SPACERERROR_TOSTRING);
    }
