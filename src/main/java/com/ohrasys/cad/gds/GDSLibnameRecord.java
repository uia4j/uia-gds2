...
public class GDSLibnameRecord extends GDSRecord {
     ...
     */
    public GDSLibnameRecord(short length, byte rectype, byte dattype, byte data[]) throws GDSRecordException {
    ...
    public String toString() {
        return GDSStringUtil.sprintf(this.i18n.getString(
                this.i18n.i18n_LIBNAME_TOSTRING), this.libname);
    }
    ...
    private String validate(String libname) throws GDSRecordException {
        String validchars = this.i18n.getString(this.i18n.i18n_LIBNAME_VALID);
        ...
        throw new GDSRecordException(this.i18n.getString(this.i18n.i18n_LIBNAME_THROW));
    }
