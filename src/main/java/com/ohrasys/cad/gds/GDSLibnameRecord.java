...
extends GDSRecord {
   ...
   */
  public GDSLibnameRecord(GDSRecord rec)
   ...
   *                              [A-Z,a-z,0-9,.,-,_].
   */
  public GDSLibnameRecord(String libname)
    throws GDSRecordException {
    setLibname(libname);
   ...
   */
  public GDSLibnameRecord(short length, byte rectype, byte dattype,
      byte data[])
    throws GDSRecordException {
   ...
   */
  public String getLibname(){return new String(libname);}
  ...
  public String toString() {
    return GDSStringUtil.sprintf(i18n.getString(
          i18n.i18n_LIBNAME_TOSTRING), libname);
  }
   ...
   *                              characters in it
   */
  private String validate(String libname)
    throws GDSRecordException {
    String validchars = i18n.getString(i18n.i18n_LIBNAME_VALID);

    if((libname != null) &&
        GDSStringUtil.consistsOf(libname.toLowerCase(), validchars) &&
        (libname.length() <= 256) && (libname.length() >= 1)){return libname;}

    throw new GDSRecordException(i18n.getString(i18n.i18n_LIBNAME_THROW));
  }
