 ...
 * @since    1.5
 */
public class GDSStrclassRecord extends GDSRecord {
     ...
     */
    public GDSStrclassRecord() throws GDSRecordException {
     ...
     */
    public GDSStrclassRecord(GDSRecord rec) throws GDSRecordException {
     ...
     */
    public GDSStrclassRecord(int length, byte rectype, byte dattype, byte data[]) throws GDSRecordException {
    ...
    public String toString() {
        return GDSStringUtil.sprintf(GDSI18NFactory.getString(
                GDSI18NFactory.i18n_STRCLASS_TOSTRING), this.strclass);
    }
