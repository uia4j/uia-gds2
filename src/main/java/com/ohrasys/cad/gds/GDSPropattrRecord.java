 ...
 * @since    1.5
 */
public class GDSPropattrRecord extends GDSRecord {
     ...
     */
    public GDSPropattrRecord(GDSRecord rec) throws GDSRecordException {
     ...
     */
    public GDSPropattrRecord(short propattr) throws GDSRecordException {
     ...
     */
    public GDSPropattrRecord(int length, byte rectype, byte dattype, byte data[]) throws GDSRecordException {
     ...
     * @throws  GDSRecordException  If the attribute is not in the range 1:127.
     */
    public void setPropattr(short propattr) throws GDSRecordException {
    ...
    public String toString() {
        return GDSStringUtil.sprintf(GDSI18NFactory.getString(
                GDSI18NFactory.i18n_PROPATTR_TOSTRING), this.propattr);
    }
     ...
     */
    private short validate(short propattr) throws GDSRecordException {
        if ((propattr >= 1) && (propattr <= 127)) {
            return propattr;
        }
