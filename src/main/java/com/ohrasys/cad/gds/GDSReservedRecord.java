 ...
 * @since    1.5
 */
public class GDSReservedRecord extends GDSRecord {
     ...
     */
    public GDSReservedRecord() throws GDSRecordException {
        throw new GDSRecordException(GDSI18NFactory.getString(GDSI18NFactory.i18n_RESERVED_THROW));
    }
     ...
     */
    public GDSReservedRecord(GDSRecord rec) throws GDSRecordException {
     ...
     * @throws  GDSRecordException  If the record is malformed.
     */
    public GDSReservedRecord(int length, byte rectype, byte dattype, byte data[]) throws GDSRecordException {
    ...
    public String toString() {
        return GDSI18NFactory.getString(GDSI18NFactory.i18n_RESERVED_TOSTRING);
    }
