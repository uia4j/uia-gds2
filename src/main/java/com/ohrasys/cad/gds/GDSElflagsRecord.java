 ...
 * @since    1.5
 */
public class GDSElflagsRecord extends GDSRecord {
     ...
     */
    public GDSElflagsRecord(GDSRecord rec) throws GDSRecordException {
     ...
     */
    public GDSElflagsRecord(boolean isTemplate, boolean isExternal) throws GDSRecordException {
     ...
     * @throws  GDSRecordException  If the record is malformed.
     */
    public GDSElflagsRecord(int length, byte rectype, byte dattype, byte data[]) throws GDSRecordException {
    ...
    public String toString() {
        return GDSStringUtil.sprintf(GDSI18NFactory.getString(
                GDSI18NFactory.i18n_ELFLAGS_TOSTRING), this.template, this.external);
    }
