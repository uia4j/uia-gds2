 ...
 * @since    1.5
 */
public class GDSEndstrRecord extends GDSRecord {
     ...
     */
    public GDSEndstrRecord() throws GDSRecordException {
        this.length = (short) 4;
        this.rectype = ENDSTR;
     ...
     */
    public GDSEndstrRecord(GDSRecord rec) throws GDSRecordException {
     ...
     * @throws  GDSRecordException  If the record is malformed.
     */
    public GDSEndstrRecord(int length, byte rectype, byte dattype, byte data[]) throws GDSRecordException {
    ...
    public String toString() {
        return GDSI18NFactory.getString(GDSI18NFactory.i18n_ENDSTR_TOSTRING);
    }
