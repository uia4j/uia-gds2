 ...
 * @since    1.5
 */
public class BasicFormatBodyValidator extends BNFRequiredTest {
     ...
     */
    public BasicFormatBodyValidator() throws BNFTestException {
        super(buildTests());
    }
    ...
    private static BNFTestImplementor[] buildTests() throws BNFTestException {
        return new BNFTestImplementor[] { new BNFNoFallthruTest(
                GDSRecord.FORMAT) };
    }
