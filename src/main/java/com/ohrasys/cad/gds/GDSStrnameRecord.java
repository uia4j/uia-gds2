...
extends GDSRecord {
   ...
   */
  public GDSStrnameRecord(GDSRecord rec)
   ...
   *                              [A-Z,a-z,0-9,?,_,$]
   */
  public GDSStrnameRecord(String strname)
    throws GDSRecordException {
    setStrname(strname);
   ...
   */
  public GDSStrnameRecord(short length, byte rectype, byte dattype,
      byte data[])
    throws GDSRecordException {
   ...
   */
  public String getStrname(){return new String(this.strname);}
  ...
  public String toString() {
    return GDSStringUtil.sprintf(i18n.getString(
          i18n.i18n_STRNAME_TOSTRING), strname);
  }
