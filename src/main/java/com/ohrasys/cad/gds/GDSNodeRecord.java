...
/**
 * Represents a GDSII NODE record.
 *
...
public class GDSNodeRecord extends GDSRecord {
     ...
     */
    public GDSNodeRecord() throws GDSRecordException {
        this.rectype = NODE;
     ...
     *
     * @throws  GDSRecordException  If the record is not a valid NODE record.
     */
    public GDSNodeRecord(GDSRecord rec) throws GDSRecordException {
     ...
     * @throws  GDSRecordException  If the record is malformed.
     */
    public GDSNodeRecord(int length, byte rectype, byte dattype, byte data[]) throws GDSRecordException {
        super(length, rectype, dattype, data);
        validateNodataRec(NODE);
    }
    ...
    public String toString() {
        return GDSI18NFactory.getString(GDSI18NFactory.i18n_NODE_TOSTRING);
    }
} // end class GDSNodeRecord
