 ...
 * @since    1.5
 */
public class GDSEndmasksRecord
extends GDSRecord {
  /**
   ...
   */
  public GDSEndmasksRecord(GDSRecord rec)
    throws GDSRecordException {
   ...
   * @throws  GDSRecordException  If the record is malformed.
   */
  public GDSEndmasksRecord(short length, byte rectype, byte dattype,
      byte data[])
    throws GDSRecordException {
   ...
   */
  public String toString(){return i18n.getString(i18n.i18n_ENDMASKS_TOSTRING);}
