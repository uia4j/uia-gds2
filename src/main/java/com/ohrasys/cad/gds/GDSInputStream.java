...
extends FileInputStream {
   ...
   *                                 readable
   */
  public GDSInputStream(String name)
   ...
   *                                 readable
   */
  public GDSInputStream(File file)
   ...
   *                                 readable
   */
  public GDSInputStream(FileDescriptor fdObj)
  ...
  public GDSRecord readRecord()
    ...
    short length  = GDSByteConverter.readShort(this);
    byte  data[]  = null;
