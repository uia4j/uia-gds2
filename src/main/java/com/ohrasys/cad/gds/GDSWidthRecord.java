...
public class GDSWidthRecord extends GDSRecord {
     ...
     * @throws  GDSRecordException  If the record is malformed.
     */
    public GDSWidthRecord(int length, byte rectype, byte dattype, byte data[]) throws GDSRecordException {
    ...
    public String toString() {
        return GDSStringUtil.sprintf(GDSI18NFactory.getString(GDSI18NFactory.i18n_WIDTH_TOSTRING),
                this.width);
    }
