 ...
 * @since    1.5
 */
public class GDSOutputStream extends FileOutputStream {
     ...
     *                                 readable
     */
    public GDSOutputStream(String name) throws FileNotFoundException {
        super(name);
    }
     ...
     *                                 readable
     */
    public GDSOutputStream(File file) throws FileNotFoundException {
        super(file);
    }
     ...
     *                                 readable
     */
    public GDSOutputStream(FileDescriptor fdObj) throws FileNotFoundException {
        super(fdObj);
    }
     ...
     */
    public int writeRecord(GDSRecord record) throws IOException {
