 ...
 * @since    1.5
 */
public class GDSTextnodeRecord extends GDSRecord {
     ...
     */
    public GDSTextnodeRecord() throws GDSRecordException {
     ...
     */
    public GDSTextnodeRecord(GDSRecord rec) throws GDSRecordException {
     ...
     * @throws  GDSRecordException  If the record is malformed.
     */
    public GDSTextnodeRecord(int length, byte rectype, byte dattype, byte data[]) throws GDSRecordException {
    ...
    public String toString() {
        return GDSI18NFactory.getString(GDSI18NFactory.i18n_TEXTNODE_TOSTRING);
    }
