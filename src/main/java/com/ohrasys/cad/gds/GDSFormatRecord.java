...
extends GDSRecord {
   ...
   */
  public GDSFormatRecord(short length, byte rectype, byte dattype,
      byte data[])
    throws GDSRecordException {
   ...
   *          EDSIII_FILTERED.
   */
  public short getFormat(){return this.format;}
  ...
  public String toString() {
    ...
    switch(format) {
      case 0:
        result = i18n.getString(i18n.i18n_FORMAT_TOSTRING1);

        break;

      case 1:
        result = i18n.getString(i18n.i18n_FORMAT_TOSTRING2);

        break;

      case 2:
        result = i18n.getString(i18n.i18n_FORMAT_TOSTRING3);

        break;

      case 3:
        result = i18n.getString(i18n.i18n_FORMAT_TOSTRING4);

        break;

      default:
        result = i18n.getString(i18n.i18n_FORMAT_TOSTRING5);
    }
   ...
   *                              FILTERED/ARCHIVED
   */
  private short validate(short format)
    throws GDSRecordException {
    if((format >= GDSII_ARCHIVED) && (format <= EDSIII_FILTERED)) {
      return format;
    }

    throw new GDSRecordException(i18n.getString(i18n.i18n_FORMAT_THROW));
  }
