...
public class GDSXyRecord extends GDSRecord {
     ...
     */
    public GDSXyRecord(short length, byte rectype, byte dattype, byte data[]) throws GDSRecordException {
        super(length, rectype, dattype, data);
        validateIntRec(XY, MAX_REC_LEN, 8);

        if ((data.length % 8) != 0) {
            throw new GDSRecordException(this.i18n.getString(this.i18n.i18n_XY_THROW1));
        }
    ...
    public void setXy(Point xy[]) throws GDSRecordException {
        if (xy.length < 1) {
            throw new GDSRecordException(this.i18n.getString(this.i18n.i18n_XY_THROW2));
        }
    ...
    public String toString() {
        String result = new String(this.i18n.getString(this.i18n.i18n_XY_TOSTRING1));
        result += " " /*NOI18N*/;
        ...
        for (int i = 0; i < this.xy.length; i++) {
            ...
            result += GDSStringUtil.sprintf(this.i18n.getString(
                    this.i18n.i18n_XY_TOSTRING2), this.xy[i].x, this.xy[i].y);
