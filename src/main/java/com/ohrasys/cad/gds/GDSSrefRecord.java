 ...
 * @since    1.5
 */
public class GDSSrefRecord extends GDSRecord {
     ...
     */
    public GDSSrefRecord() throws GDSRecordException {
        this.rectype = SREF;
     ...
     */
    public GDSSrefRecord(GDSRecord rec) throws GDSRecordException {
     ...
     * @throws  GDSRecordException  If the record is malformed.
     */
    public GDSSrefRecord(int length, byte rectype, byte dattype, byte data[]) throws GDSRecordException {
    ...
    public String toString() {
        return GDSI18NFactory.getString(GDSI18NFactory.i18n_SREF_TOSTRING);
    }
