...
extends GDSRecord {
   ...
   */
  public GDSMaskRecord(String mask)
   ...
   * @throws  GDSRecordException  If the record is malformed.
   */
  public GDSMaskRecord(GDSRecord rec)
    throws GDSRecordException {
   ...
   * @throws  GDSRecordException  If the record is malformed.
   */
  public GDSMaskRecord(short length, byte rectype, byte dattype,
      byte data[])
    throws GDSRecordException {
   ...
   */
  public String getMask(){return new String(this.mask);}
  ...
  public String toString() {
    return GDSStringUtil.sprintf(i18n.getString(i18n.i18n_MASK_TOSTRING),
        mask);
  }
  ...
  private String validate(String mask)
    ...
    if((mask != null) && (mask.length() <= MAX_REC_LEN) &&
        (mask.length() >= 1)){return mask;}

    throw new GDSRecordException(GDSStringUtil.sprintf(
        i18n.getString(i18n.i18n_MASK_THROW), MAX_REC_LEN));
  }
