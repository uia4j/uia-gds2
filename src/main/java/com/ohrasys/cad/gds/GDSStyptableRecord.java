 ...
 * @since    1.5
 */
public class GDSStyptableRecord extends GDSRecord {
     ...
     */
    public GDSStyptableRecord() throws GDSRecordException {
        throw new GDSRecordException(GDSI18NFactory.getString(GDSI18NFactory.i18n_STYPTABLE_THROW));
    }
     ...
     */
    public GDSStyptableRecord(GDSRecord rec) throws GDSRecordException {
     ...
     * @throws  GDSRecordException  If the record is malformed.
     */
    public GDSStyptableRecord(int length, byte rectype, byte dattype, byte data[]) throws GDSRecordException {
    ...
    public String toString() {
        return GDSI18NFactory.getString(GDSI18NFactory.i18n_STYPTABLE_TOSTRING);
    }
