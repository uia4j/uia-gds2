...
extends JTree {
  ...
  private static final String REF_LIBS_LABEL =
    "Reference Libraries" /*NOI18N*/;

  /** Access control label */
  private static final String ACCESS_CONTROLS_LABEL =
    "Access Controls" /*NOI18N*/;
  ...
  private static final String GEO_ELEMENTS_LABEL =
    "Geometry Elements" /*NOI18N*/;

  /** Reference element label */
  private static final String REF_ELEMENTS_LABEL =
    "Reference Elements" /*NOI18N*/;
   ...
   */
  private DefaultMutableTreeNode buildFontsTree(DefaultMutableTreeNode top,
      String fonts[]) {
    if((fonts == null) || (fonts.length == 0)){return top;}
   ...
   */
  private DefaultMutableTreeNode buildReflibsTree(DefaultMutableTreeNode top,
      String refLibs[]) {
    if((refLibs == null) || (refLibs.length == 0)){return top;}
   ...
   */
  private DefaultMutableTreeNode buildTree(DefaultMutableTreeNode top,
      Object obj) {
    ...
    if(obj instanceof Database) {
      ...
      if((acl == null) || (acl.length == 0)){return top;}
      ...
      if((structs == null) || (structs.length == 0)){return top;}
      ...
      if((fmt.getMasks() == null) || (fmt.getMasks().length == 0)){return top;}
      ...
      com.ohrasys.cad.gds.dao.Element elements[] =
        (com.ohrasys.cad.gds.dao.Element[])obj;
      if((elements == null) || (elements.length == 0)){return top;}
      ...
      if(geoElemNode != null){top.add(geoElemNode);}
      if(refElemNode != null){top.add(refElemNode);}
    } else if(obj instanceof com.ohrasys.cad.gds.dao.Element) {
      ...
      if((props == null) || (props.length == 0)){return top;}
   ...
   * @author  $Author: tvaline $
   */
  private final class GDSTreeRenderer
  extends DefaultTreeCellRenderer {
    ...
    public GDSTreeRenderer() {
      dbIcon      = new ImageIcon(getClass().getResource(
            "images/db.gif" /*NOI18N*/));
      aclIcon     = new ImageIcon(getClass().getResource(
            "images/acl.gif" /*NOI18N*/));
      acIcon      = new ImageIcon(getClass().getResource(
            "images/ac.gif" /*NOI18N*/));
      fontsIcon   = new ImageIcon(getClass().getResource(
            "images/fonts.gif" /*NOI18N*/));
      fontIcon    = new ImageIcon(getClass().getResource(
            "images/font.gif" /*NOI18N*/));
      geoElemIcon = new ImageIcon(getClass().getResource(
            "images/geo.gif" /*NOI18N*/));
      libsIcon    = new ImageIcon(getClass().getResource(
            "images/libs.gif" /*NOI18N*/));
      libIcon     = new ImageIcon(getClass().getResource(
            "images/lib.gif" /*NOI18N*/));
      masksIcon   = new ImageIcon(getClass().getResource(
            "images/masks.gif" /*NOI18N*/));
      maskIcon    = new ImageIcon(getClass().getResource(
            "images/mask.gif" /*NOI18N*/));
      propsIcon   = new ImageIcon(getClass().getResource(
            "images/props.gif" /*NOI18N*/));
      propIcon    = new ImageIcon(getClass().getResource(
            "images/prop.gif" /*NOI18N*/));
      refElemIcon = new ImageIcon(getClass().getResource(
            "images/ref.gif" /*NOI18N*/));
      refIcon     = new ImageIcon(getClass().getResource(
            "images/refs.gif" /*NOI18N*/));
      aryRefIcon  = new ImageIcon(getClass().getResource(
            "images/ary.gif" /*NOI18N*/));
      structsIcon = new ImageIcon(getClass().getResource(
            "images/structs.gif" /*NOI18N*/));
      structIcon  = new ImageIcon(getClass().getResource(
            "images/struct.gif" /*NOI18N*/));
      boxIcon     = new ImageIcon(getClass().getResource(
            "images/box.gif" /*NOI18N*/));
      bdyIcon     = new ImageIcon(getClass().getResource(
            "images/bdy.gif" /*NOI18N*/));
      pathIcon    = new ImageIcon(getClass().getResource(
            "images/path.gif" /*NOI18N*/));
      nodeIcon    = new ImageIcon(getClass().getResource(
    ...
    public Component getTreeCellRendererComponent(
      ...
      if(((DefaultMutableTreeNode)value).equals(tree.getModel().getRoot())) {
        setIcon(dbIcon);
        setToolTipText(i18n.getString("JGDSPARSER_RIGHT_CLICK" /* NOI18N */));
        if(((DefaultMutableTreeNode)value).getUserObject() == null) {
          setText(NO_DESIGN_LABEL);
        }
      } else if(((DefaultMutableTreeNode)value).getUserObject() instanceof
          String) {
        String string = (String)((DefaultMutableTreeNode)value)
            .getUserObject();
        if(string.equals(ACCESS_CONTROLS_LABEL)){setIcon(aclIcon);}
        else if(string.equals(STRUCTURES_LABEL)){setIcon(structsIcon);}
        else if(string.equals(GEO_ELEMENTS_LABEL)){setIcon(geoElemIcon);}
        else if(string.equals(REF_ELEMENTS_LABEL)){setIcon(refElemIcon);}
        else if(string.equals(REF_LIBS_LABEL)){setIcon(libsIcon);}
        else if(string.equals(MASKS_LABEL)){setIcon(masksIcon);}
        else if(string.equals(PROPS_LABEL)){setIcon(propsIcon);}
        else if(string.equals(FONTS_LABEL)){setIcon(fontsIcon);}
        if(((DefaultMutableTreeNode)((DefaultMutableTreeNode)value).getParent()).getUserObject()
              .equals(FONTS_LABEL)){setIcon(fontIcon);}
        if(((DefaultMutableTreeNode)((DefaultMutableTreeNode)value).getParent()).getUserObject()
              .equals(MASKS_LABEL)){setIcon(maskIcon);}
        if(((DefaultMutableTreeNode)((DefaultMutableTreeNode)value).getParent()).getUserObject()
              .equals(REF_LIBS_LABEL)){setIcon(libIcon);}
      } else if(((DefaultMutableTreeNode)value).getUserObject() instanceof
          Structure){setIcon(structIcon);}
      else if(((DefaultMutableTreeNode)value).getUserObject() instanceof
          GDSAccessControl){setIcon(acIcon);}
      else if(((DefaultMutableTreeNode)value).getUserObject() instanceof
          StructureReference){setIcon(refIcon);}
      else if(((DefaultMutableTreeNode)value).getUserObject() instanceof
          ArrayReference){setIcon(aryRefIcon);}
      else if(((DefaultMutableTreeNode)value).getUserObject() instanceof
          Text){setIcon(fontIcon);}
      else if(((DefaultMutableTreeNode)value).getUserObject() instanceof
          Property){setIcon(propIcon);}
      else if(((DefaultMutableTreeNode)value).getUserObject() instanceof
          com.ohrasys.cad.gds.dao.Box){setIcon(boxIcon);}
      else if(((DefaultMutableTreeNode)value).getUserObject() instanceof
          Boundary){setIcon(bdyIcon);}
      else if(((DefaultMutableTreeNode)value).getUserObject() instanceof
