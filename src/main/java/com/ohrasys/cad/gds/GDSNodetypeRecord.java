 ...
 * @since    1.5
 */
public class GDSNodetypeRecord extends GDSRecord {
     ...
     */
    public GDSNodetypeRecord(GDSRecord rec) throws GDSRecordException {
     ...
     */
    public GDSNodetypeRecord(short nodetype) throws GDSRecordException {
     ...
     */
    public GDSNodetypeRecord(int length, byte rectype, byte dattype, byte data[]) throws GDSRecordException {
     ...
     */
    public void setNodetype(short nodetype) throws GDSRecordException {
    ...
    public String toString() {
        return GDSI18NFactory.getString(GDSI18NFactory.i18n_NODETYPE_TOSTRING);
    }
     ...
     *                              0-255
     */
    private short validate(short nodetype) throws GDSRecordException {
        if ((nodetype >= 0) && (nodetype <= 255)) {
            return nodetype;
        }

        throw new GDSRecordException(GDSI18NFactory.getString(GDSI18NFactory.i18n_NODETYPE_THROW));
    }
