 ...
 * @since    1.5
 */
public class GDSUserconstraintRecord extends GDSRecord {
     ...
     */
    public GDSUserconstraintRecord() throws GDSRecordException {
     ...
     *                              record.
     */
    public GDSUserconstraintRecord(GDSRecord rec) throws GDSRecordException {
     ...
     * @throws  GDSRecordException  If the record is malformed.
     */
    public GDSUserconstraintRecord(int length, byte rectype, byte dattype, byte data[]) throws GDSRecordException {
    ...
    public String toString() {
        return GDSI18NFactory.getString(GDSI18NFactory.i18n_USERCONSTRAINT_TOSTRING);
    }
