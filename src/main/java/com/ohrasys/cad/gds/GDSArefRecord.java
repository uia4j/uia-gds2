...
/**
 * Represents a GDSII AREF record.
 *
 ...
 * @since    1.5
 */
public class GDSArefRecord extends GDSRecord {
     ...
     */
    public GDSArefRecord() throws GDSRecordException {
        this.length = (short) 4;
        this.rectype = AREF;
     ...
     *
     * @throws  GDSRecordException  If the record is not a valid AREF record.
     */
    public GDSArefRecord(GDSRecord rec) throws GDSRecordException {
     ...
     * @throws  GDSRecordException  If the record is malformed.
     */
    public GDSArefRecord(int length, byte rectype, byte dattype, byte data[]) throws GDSRecordException {
        super(length, rectype, dattype, data);
        validateNodataRec(AREF);
    }
    ...
    public String toString() {
        return GDSI18NFactory.getString(GDSI18NFactory.i18n_AREF_TOSTRING);
    }
} // end class GDSArefRecord
