 ...
 * @since    1.5
 */
public class GDSSrfnameRecord extends GDSRecord {
     ...
     */
    public GDSSrfnameRecord(GDSRecord rec) throws GDSRecordException {
     ...
     */
    public GDSSrfnameRecord(String srfname) throws GDSRecordException {
        setSrfname(srfname);
     ...
     */
    public GDSSrfnameRecord(int length, byte rectype, byte dattype, byte data[]) throws GDSRecordException {
    ...
    public String getSrfname() {
        return new String(this.srfname);
    }
     ...
     * @throws  GDSRecordException  If the rules file name is of zero length.
     */
    public void setSrfname(String srfname) throws GDSRecordException {
    ...
    public String toString() {
        return GDSStringUtil.sprintf(GDSI18NFactory.getString(
                GDSI18NFactory.i18n_SRFNAME_TOSTRING), this.srfname);
    }
