...
extends GDSRecord {
   ...
   */
  public GDSAngleRecord(GDSRecord rec)
   ...
   */
  public GDSAngleRecord(double angle)
    throws GDSRecordException {
    setAngle(angle);
    this.rectype = ANGLE;
   ...
   */
  public GDSAngleRecord(short length, byte rectype, byte dattype,
      byte data[])
    throws GDSRecordException {
  ...
  public String toString() {
    return GDSStringUtil.sprintf(i18n.getString(i18n.i18n_ANGLE_TOSTRING),
        angle);
  }
