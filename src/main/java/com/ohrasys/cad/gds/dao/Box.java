 ...
 */
public class Box extends GeometryElement implements InfoProvider {
     ...
     * @param  points    The points defining the box
     */
    public Box(boolean external, boolean template, int group, int layer, int datatype, Point points[]) {
    ...
    public String toString() {
        return this.i18n.getString("I18N_BOX" /*NOI18N*/);
    }
} // end class Box
