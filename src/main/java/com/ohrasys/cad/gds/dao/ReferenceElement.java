 ...
 */
public class ReferenceElement extends Element implements InfoProvider {
     ...
     */
    public ReferenceElement(boolean external, boolean template, int group, String name, Transform transform, Point points[]) {
    ...
    public String getInfo() {
        ...
        result += this.i18n.getString("I18N_REF_SPEC" /*NOI18N*/);
        result += super.getInfo();
        result += String.format(this.i18n.getString("I18N_REF_NAME" /*NOI18N*/),
                getName());
    ...
    public String toString() {
        return this.i18n.getString("I18N_REF_EL" /*NOI18N*/);
    }
