 ...
 */
public class Database implements InfoProvider {
    ...
    public String getInfo() {
        ...
        result += String.format(this.i18n.getString("I18N_DB_NAME" /*NOI18N*/), this.name);
        result += String.format(this.i18n.getString("I18N_DB_UUPERDBU" /*NOI18N*/),
                this.userUnitsPerDBU);
        result += String.format(this.i18n.getString("I18N_DB_METERSPERDBU" /*NOI18N*/),
                this.metersPerDBU);
        result += String.format(this.i18n.getString("I18N_DB_VERSION" /*NOI18N*/),
                this.version);
        result += String.format(this.i18n.getString("I18N_DB_MODIFIED" /*NOI18N*/),
                this.modified.toString());
        result += String.format(this.i18n.getString("I18N_DB_ACCESSED" /*NOI18N*/),
                this.accessed.toString());
        if (this.accessControls != null) {
            result += String.format(this.i18n.getString("I18N_DB_ACCSCTL" /*NOI18N*/),
                    this.accessControls.length);
        }
        if (this.attributeFile != null) {
            result += String.format(this.i18n.getString("I18N_DB_AFILE" /*NOI18N*/),
                    this.attributeFile);
        }
        if (this.dirSize > 0) {
            result += String.format(this.i18n.getString("I18N_DB_DIRSIZE" /*NOI18N*/),
                    this.dirSize);
        }
        if (this.fonts != null) {
            result += String.format(this.i18n.getString("I18N_DB_FONT" /*NOI18N*/),
                    this.fonts.length);
        }
        if (this.format != null) {
            result += this.format.getInfo();
        }
        if (this.generations > 0) {
            result += String.format(this.i18n.getString("I18N_DB_GEN" /*NOI18N*/),
                    this.generations);
        }
        if (this.refLibs != null) {
            result += String.format(this.i18n.getString("I18N_DB_REFLIB" /*NOI18N*/),
                    this.refLibs.length);
        }
        if (this.spacingRulesFile != null) {
            result += String.format(this.i18n.getString("I18N_DB_SRF" /*NOI18N*/),
                    this.spacingRulesFile);
        }
        if (this.structures != null) {
            result += String.format(this.i18n.getString("I18N_DB_STRUCT" /*NOI18N*/),
     ...
     */
    public String getSpacingRulesFile() {
        return this.spacingRulesFile;
    }
     ...
     */
    public void setRefLibs(String refLibs[]) {
