 ...
 */
public class StructureReference extends ReferenceElement implements InfoProvider {
    ...
    public StructureReference(boolean external, boolean template, int group, String name, Transform transform, Point points[]) {
