 ...
 */
public class ArrayReference extends ReferenceElement implements InfoProvider {
    ...
    public ArrayReference() {
        this(new String(), 0, 0, new Point[0]);
    }
     ...
     * @param  points     The points defining the array boundary
     */
    public ArrayReference(boolean external, boolean template, int group, String name, Transform transform, int columns, int rows, Point points[]) {
    ...
    public String getInfo() {
        ...
        result += String.format(this.i18n.getString("I18N_ARYREF_COLS" /*NOI18N*/),
                getColumns());
        result += String.format(this.i18n.getString("I18N_ARYREF_ROWS" /*NOI18N*/),
                getRows());
