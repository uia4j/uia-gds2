 ...
 */
public class Path extends GeometryElement implements InfoProvider {
     ...
     * @param  points          The points defining the path
     */
    public Path(boolean external, boolean template, int group, int layer, int datatype, int pathtype, int width, int startExtension, int endExtension, Point points[]) {
    ...
    public String getInfo() {
        ...
        result += String.format(this.i18n.getString("I18N_PATH_END" /*NOI18N*/),
                getEndExtension());
        result += String.format(this.i18n.getString("I18N_PATH_START" /*NOI18N*/),
                getStartExtension());
        result += String.format(this.i18n.getString("I18N_PATH_TYPE" /*NOI18N*/),
                getPathtype());
        result += String.format(this.i18n.getString("I18N_PATH_WIDTH" /*NOI18N*/),
                getWidth());
    ...
    public String toString() {
        return this.i18n.getString("I18N_PATH" /*NOI18N*/);
    }
} // end class Path
