...
implements InfoProvider {
   ...
   */
  public Element(){this(false, false, 0, new Point[]{new Point(0, 0)});}
   ...
   */
  public Element(boolean isExternal, boolean isTemplate, int group,
      Point points[]) {
  ...
  public String getInfo() {
    ...
    result += i18n.getString("I18N_EL_GEN" /*NOI18N*/);
    result += (i18n.getString("I18N_EL_EXT" /*NOI18N*/) + isExternal() +
        "\n" /*NOI18N*/);
    result += (i18n.getString("I18N_EL_TEMPLATE" /*NOI18N*/) + isTemplate() +
        "\n" /*NOI18N*/);
    result += (i18n.getString("I18N_EL_GROUP" /*NOI18N*/) + getGroup() +
        "\n" /*NOI18N*/);
    result += (i18n.getString("I18N_EL_POINTS" /*NOI18N*/));
    for(int i = 0;i < points.length;i++) {
      result += String.format(i18n.getString("I18N_EL_POINT" /*NOI18N*/),
          points[i].x,
          points[i].y);
   ...
   */
  public String toString(){return i18n.getString("I18N_EL_ELEM" /*NOI18N*/);}
} // end class Element
