 ...
 */
public class Node extends GeometryElement implements InfoProvider {
     ...
     * @param  points    The points defining the node
     */
    public Node(boolean external, boolean template, int group, int layer, int datatype, Point points[]) {
    ...
    public String toString() {
        return this.i18n.getString("I18N_NODE" /*NOI18N*/);
    }
} // end class Node
