...
implements InfoProvider {
   ...
   */
  public Format(){this(GDSFormatRecord.GDSII_ARCHIVED);}
   ...
   */
  public Format(int type){this(type, new String[0]);}
   ...
   */
  public String[] getMasks(){return this.masks;}
   ...
   */
  public void setMasks(String masks[]){this.masks = masks;}
   ...
   */
  public String toString(){return i18n.getString("I18N_FMT" /*NOI18N*/);}
} // end class Format
