...
implements InfoProvider {
   ...
   */
  public Text(){this(0, new Transform(), new String(), new Point[0]);}
   ...
   */
  public Text(boolean external, boolean template, int group, int layer,
      int datatype, int vJustify, int hJustify, int font, int pathStyle,
      int width, Transform transform, Point points[], String value) {
   ...
   */
  public int getHJustify(){return this.hJustify;}
  ...
  public String getInfo() {
    ...
    result += String.format(i18n.getString("I18N_TEXT_FONT" /*NOI18N*/),
        getFont());
    result += String.format(i18n.getString("I18N_TEXT_HJUST" /*NOI18N*/),
        getHJustify());
    result += String.format(i18n.getString("I18N_TEXT_VJUST" /*NOI18N*/),
        getVJustify());
    result += String.format(i18n.getString("I18N_TEXT_PSTYLE" /*NOI18N*/),
        getPathStyle());
    result += String.format(i18n.getString("I18N_TEXT_STRING" /*NOI18N*/),
        getValue());
    result += String.format(i18n.getString("I18N_TEXT_WIDTH" /*NOI18N*/),
        getWidth());
   ...
   */
  public int getPathStyle(){return this.pathStyle;}
   ...
   */
  public int getVJustify(){return this.vJustify;}
   ...
   */
  public void setHJustify(int hJustify){this.hJustify = hJustify;}
   ...
   */
  public void setPathStyle(int pathStyle){this.pathStyle = pathStyle;}
   ...
   */
  public void setVJustify(int vJustify){this.vJustify = vJustify;}
  ...
  public String toString() {
    return i18n.getString("I18N_TEXT_TXT" /*NOI18N*/) + getValue() +
      i18n.getString("I18N_TEXT_CPAREN" /*NOI18N*/);
  }
} // end class Text
