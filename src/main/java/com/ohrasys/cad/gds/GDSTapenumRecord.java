 ...
 * @since    1.5
 */
public class GDSTapenumRecord extends GDSRecord {
     ...
     */
    public GDSTapenumRecord(GDSRecord rec) throws GDSRecordException {
     ...
     */
    public GDSTapenumRecord(short tapenum) throws GDSRecordException {
        setTapenum(tapenum);
     ...
     */
    public GDSTapenumRecord(int length, byte rectype, byte dattype, byte data[]) throws GDSRecordException {
     ...
     * @throws  GDSRecordException  If the tapenumber is less than 1.
     */
    public void setTapenum(short tapenum) throws GDSRecordException {
    ...
    public String toString() {
        return GDSStringUtil.sprintf(GDSI18NFactory.getString(
                GDSI18NFactory.i18n_TAPENUM_TOSTRING), this.tapenum);
    }
     ...
     */
    private short validate(short tapenum) throws GDSRecordException {
        if (tapenum < 1) {
            throw new GDSRecordException(GDSI18NFactory.getString(
                    GDSI18NFactory.i18n_TAPENUM_THROW));
        }
