 ...
 * @since    1.5
 */
public class GDSNodeportRecord
extends GDSRecord {
  /**
   ...
   */
  public GDSNodeportRecord(GDSRecord rec)
    throws GDSRecordException {
   ...
   * @throws  GDSRecordException  If the record is malformed.
   */
  public GDSNodeportRecord(short length, byte rectype, byte dattype,
      byte data[])
    throws GDSRecordException {
   ...
   */
  public String toString(){return i18n.getString(i18n.i18n_NODEPORT_TOSTRING);}
