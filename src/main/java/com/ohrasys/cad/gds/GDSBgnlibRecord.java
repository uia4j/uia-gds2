...
extends GDSRecord {
   ...
   */
  public GDSBgnlibRecord(GDSRecord rec)
   ...
   */
  public GDSBgnlibRecord(Date mod, Date access)
    throws GDSRecordException {
    length              = (short)28;
    rectype             = BGNLIB;
    dattype             = SHORT_TYPE;
   ...
   * @throws  GDSRecordException  If the record is malformed.
   */
  public GDSBgnlibRecord(short length, byte rectype, byte dattype,
      byte data[])
    throws GDSRecordException {
  ...
  public String toString() {
    return GDSStringUtil.sprintf(i18n.getString(i18n.i18n_BGNLIB_TOSTRING),
