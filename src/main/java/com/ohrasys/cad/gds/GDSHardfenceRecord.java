 ...
 * @since    1.5
 */
public class GDSHardfenceRecord
extends GDSRecord {
  /**
   ...
   */
  public GDSHardfenceRecord(GDSRecord rec)
    throws GDSRecordException {
   ...
   * @throws  GDSRecordException  If the record is malformed.
   */
  public GDSHardfenceRecord(short length, byte rectype, byte dattype,
      byte data[])
    throws GDSRecordException {
  ...
  public String toString() {
    return i18n.getString(i18n.i18n_HARDFENCE_TOSTRING);
  }
