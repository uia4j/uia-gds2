 ...
 * @since    1.5
 */
public class GDSEndextnRecord extends GDSRecord {
     ...
     */
    public GDSEndextnRecord(int endextn) throws GDSRecordException {
        setEndextn(endextn);
     ...
     */
    public GDSEndextnRecord(GDSRecord rec) throws GDSRecordException {
     ...
     * @throws  GDSRecordException  If the record is malformed.
     */
    public GDSEndextnRecord(int length, byte rectype, byte dattype, byte data[]) throws GDSRecordException {
    ...
    public String toString() {
        return GDSStringUtil.sprintf(GDSI18NFactory.getString(
                GDSI18NFactory.i18n_ENDEXTN_TOSTRING), this.endextn);
    }
