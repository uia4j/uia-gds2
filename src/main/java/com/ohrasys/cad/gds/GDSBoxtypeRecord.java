 ...
 * @since    1.5
 */
public class GDSBoxtypeRecord extends GDSRecord {
     ...
     */
    public GDSBoxtypeRecord(GDSRecord rec) throws GDSRecordException {
     ...
     */
    public GDSBoxtypeRecord(short boxtype) throws GDSRecordException {
        setBoxtype(boxtype);
     ...
     * @throws  GDSRecordException  If the record is malformed.
     */
    public GDSBoxtypeRecord(int length, byte rectype, byte dattype, byte data[]) throws GDSRecordException {
     ...
     */
    public void setBoxtype(short boxtype) throws GDSRecordException {
    ...
    public String toString() {
        return GDSStringUtil.sprintf(GDSI18NFactory.getString(GDSI18NFactory.i18n_BOXTYPE_THROW),
                this.boxtype);
    }
     ...
     */
    private short validate(short boxtype) throws GDSRecordException {
        if ((boxtype >= 0) && (boxtype <= 255)) {
            return boxtype;
        }

        throw new GDSRecordException(GDSI18NFactory.getString(GDSI18NFactory.i18n_BOXTYPE_THROW));
    }
