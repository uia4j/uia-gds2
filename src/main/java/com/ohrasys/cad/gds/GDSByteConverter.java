...
public class GDSByteConverter {
     ...
     */
    public static ByteArrayOutputStream fromByte(
            byte data,
     ...
     */
    public static ByteArrayOutputStream fromDouble(
            double data,
            ByteArrayOutputStream baos) {
        DataOutputStream dos = new DataOutputStream(baos);
     ...
     */
    public static ByteArrayOutputStream fromFloat(
            float data,
            ByteArrayOutputStream baos) {
        DataOutputStream dos = new DataOutputStream(baos);
     ...
     *          appended to it.
     */
    public static ByteArrayOutputStream fromInt(
            int data,
            ByteArrayOutputStream baos) {
        DataOutputStream dos = new DataOutputStream(baos);
     ...
     *          long appended to it.
     */
    public static ByteArrayOutputStream fromLong(
            long data,
            ByteArrayOutputStream baos) {
        DataOutputStream dos = new DataOutputStream(baos);
     ...
     */
    public static ByteArrayOutputStream fromShort(
            short data,
            ByteArrayOutputStream baos) {
        DataOutputStream dos = new DataOutputStream(baos);
     ...
     */
    public static byte readByte(InputStream in) throws NumberFormatException {
        try {
     ...
     * @throws  NumberFormatException  If the an error in processing occurs.
     */
    public static long readLong(InputStream in) throws NumberFormatException {
        try {
            byte data[] = new byte[8];
            in.read(data, 0, 8);
     ...
     * @throws  NumberFormatException  If the an error in processing occurs.
     */
    public static short readShort(InputStream in) throws NumberFormatException {
        try {
     ...
     * @throws  NumberFormatException  If the an error in processing occurs.
     */
    public static byte toByte(byte bytes[]) throws NumberFormatException {
        if (bytes.length < 1) {
     ...
     * @throws  NumberFormatException  If the an error in processing occurs.
     */
    public static int toInt(byte bytes[]) throws NumberFormatException {
        if (bytes.length < 4) {
            throw new NumberFormatException(GDSI18NFactory.getString(
                    GDSI18NFactory.i18n_4TOBYTE_THROW));
        }
     ...
     * @throws  NumberFormatException  If the an error in processing occurs.
     */
    public static short toShort(byte bytes[]) throws NumberFormatException {
        if (bytes.length < 2) {
            throw new NumberFormatException(GDSI18NFactory.getString(
